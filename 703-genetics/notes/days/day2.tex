...
\begin{defn}
	...
	\]
	In a chi-squared test, the \vocab{degrees of freedom (df)} is defined as the number of independent normally distributed variables (usually $k-1$). We can then determine the $p$-value of this $\mathbb P(\text{chi-squared} \geq \chi^2 \mid \text{df degrees of freedom hypothesis is true})$. 
\end{defn}
